...
<div class="row">
  <div class="col-md-8">
    ...
    <br>
     ...
     <label for="stock">Weight</label><br>
    <input type="text" class="form-control {{$errors->first('weight') ? "is-invalid" : "" }}" placeholder="Weight" id="weight" name="weight" value="{{ old('weight') ? old('weight') :$book->weight}}">
    <div class="invalid-feedback">
      {{$errors->first('weight')}}
    </div>
    <br>
